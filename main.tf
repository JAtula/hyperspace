...
module "workers" {
  ...
  kontena_uri = "https://wild-water-501.platforms.eu-west-1.kontena.cloud"
  kontena_worker_token = "tDpsD6MxE4GSRdJtMfZiv0xdOeLYU9MKRJiCZexlmFf2D4RcyrBkcb9k3sSCA0W6igQktcPI7TPjtGCZX/5w/A=="
